...
namespace Mediapipe.Unity.Sample.FaceDetection
{
  public class FaceDetectorRunner : VisionTaskApiRunner<Tasks.Vision.FaceDetector.FaceDetector>
  {
    ...
    protected override IEnumerator Run()
    {
      ...
      Tasks.Vision.FaceDetector.FaceDetectorOptions options;
      if (config.RunningMode == Tasks.Vision.Core.RunningMode.LIVE_STREAM)
      {
          options = config.GetFaceDetectorOptions(OnFaceDetectionsOutput);
      }
      else
      {
          options = config.GetFaceDetectorOptions(null);
      }
