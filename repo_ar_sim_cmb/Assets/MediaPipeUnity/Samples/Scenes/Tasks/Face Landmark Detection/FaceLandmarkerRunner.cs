...
namespace Mediapipe.Unity.Sample.FaceLandmarkDetection
{
  public class FaceLandmarkerRunner : VisionTaskApiRunner<FaceLandmarker>
  {
    ...
    protected override IEnumerator Run()
    {
      ...
      Tasks.Vision.FaceLandmarker.FaceLandmarkerOptions options;
      if (config.RunningMode == Tasks.Vision.Core.RunningMode.LIVE_STREAM)
      {
          options = config.GetFaceLandmarkerOptions(OnFaceLandmarkDetectionOutput);
      }
      else
      {
          options = config.GetFaceLandmarkerOptions(null);
      }
